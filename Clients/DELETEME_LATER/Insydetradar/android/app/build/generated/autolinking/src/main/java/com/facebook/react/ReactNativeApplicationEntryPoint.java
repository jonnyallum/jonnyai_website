...
public class ReactNativeApplicationEntryPoint {
  public static void loadReactNative(Context context) {
    ...
    if (space.manus.insydetradar.app.t20260127215637.BuildConfig.IS_NEW_ARCHITECTURE_ENABLED) {
      DefaultNewArchitectureEntryPoint.load();
    }
    
    if (space.manus.insydetradar.app.t20260127215637.BuildConfig.IS_EDGE_TO_EDGE_ENABLED) {
